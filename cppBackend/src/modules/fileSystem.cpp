...
void FileSystem::writeError(std::string error){
    std::string content = "TIMESTAMP: " + FileSystem::getCurrentTime() + " LOG_BACK_END: " + error + "\n";
    Utils::appendInFile(content, this->parentPath + FILE_SEPARATOR  + LOG_FOLDER + FILE_SEPARATOR + ERROR_FILE);
}